...
def load_attributes(service_folder_path):
    attributes_file_path = os.path.join(service_folder_path, 'pateStandardDef4V4HourlyAttributes.txt')
    attributes = {}
...
def append_data_to_csv(service_folder_path, timestamp, value, is_anomaly):
    data_csv_path = os.path.join(service_folder_path, 'pateStandardDef4V4HourlySumProcessedData.csv')
...
def extract_last_96_hours(service_folder_path):
    processed_csv_path = os.path.join(service_folder_path, 'pateStandardDef4V4HourlySumProcessedData.csv')
    ...
    json_output_path = os.path.join(service_folder_path, 'pateStandardDef4V4HourlySum_last_96_hours_anomalies.json')
