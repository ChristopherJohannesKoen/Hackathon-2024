...
class PATEAnomalyDetector:
    ...
    def save_processed_data(self, df_resampled, output_dir):
        ...
        processed_data_path = os.path.join(output_dir, 'pateIsoTree4V3HourlySumProcessedData.csv')
...
if __name__ == "__main__":
    ...
    # Preprocess data to sum the values for each hour
    ...
    attributes_path = os.path.join(output_dir, 'pateIsoTree4V3HourlySumAttributes.txt')
