...
def load_attributes(service_folder_path):
    attributes_file_path = os.path.join(service_folder_path, 'pateIsoTree4V3HourlySumAttributes.txt')
    attributes = {}
...
def append_data_to_csv(service_folder_path, timestamp, value, is_anomaly):
    data_csv_path = os.path.join(service_folder_path, 'pateIsoTree4V3HourlySumProcessedData.csv')
...
def extract_last_96_hours(service_folder_path):
    processed_csv_path = os.path.join(service_folder_path, 'pateIsoTree4V3HourlySumProcessedData.csv')
    ...
    json_output_path = os.path.join(service_folder_path, 'pateIsoTree4V3HourlySum_last_96_hours_anomalies.json')
