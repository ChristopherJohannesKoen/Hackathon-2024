...
def load_attributes(service_folder_path):
    attributes_file_path = os.path.join(service_folder_path, 'pateStandardDef4V5DailySumAttributes.txt')
    attributes = {}
...
def append_data_to_csv(service_folder_path, timestamp, value, is_anomaly):
    data_csv_path = os.path.join(service_folder_path, 'pateStandardDef4V5DailySumProcessedData.csv')
