...
if __name__ == "__main__":
    ...
    processed_data_path = os.path.join(output_dir, 'pateStandardDef4V1PointProcessedData.csv')
    ...
    attributes_path = os.path.join(output_dir, 'pateStandardDef4V1PointProcessedAttributes.txt')
