...
if __name__ == "__main__":
    # Example of how to use the CombinedAnomalyDetector with a simulated data stream
    ...
    for i in range(1000):
        ...
        # Periodically check for anomalies and compare models
        if i % 100 == 0 and i > 0:
            print("Running PATE...")
            ...
            if comparison_results['ChosenModel'] == 'PATE':
                print("Visualizing PATE Anomalies...")
                detector.visualize_anomalies(pate_anomalies)
            else:
                print("Visualizing Isolation Forest Anomalies...")
                detector.visualize_anomalies(isolation_forest_anomalies)
