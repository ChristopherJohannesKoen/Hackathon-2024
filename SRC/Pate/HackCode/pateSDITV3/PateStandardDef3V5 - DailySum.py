...
if __name__ == "__main__":
    ...
    processed_data_path = os.path.join(output_dir, 'PateStandardDef3V5DailySumProcessedData.csv')
    ...
    attributes_path = os.path.join(output_dir, 'PateStandardDef3V5DailySumAttributes.txt')
