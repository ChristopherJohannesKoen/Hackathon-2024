...
if __name__ == "__main__":
    ...
    processed_data_path = os.path.join(output_dir, 'pateIsoTree3V1PointProcessedData.csv')
    ...
    attributes_path = os.path.join(output_dir, 'pateIsoTree3V1PointAttributes.txt')
