...
if __name__ == "__main__":
    ...
    processed_data_path = os.path.join(output_dir, 'PateStandardDef3V4HourlySumProcessedData.csv')
    ...
    attributes_path = os.path.join(output_dir, 'PateStandardDef3V4HourlyAttributes.txt')
