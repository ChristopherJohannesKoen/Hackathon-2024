...
class PATEAnomalyDetector:
    ...
    def save_processed_data(self, df_resampled, output_dir):
        ...
        processed_data_path = os.path.join(output_dir, 'pateIsoTree3V4DailySumProcessedData.csv')
...
if __name__ == "__main__":
    ...
    attributes_path = os.path.join(output_dir, 'pateIsoTree3V4DailySumAttributes.txt')
