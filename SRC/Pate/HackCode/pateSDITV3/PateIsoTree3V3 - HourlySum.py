...
class PATEAnomalyDetector:
    ...
    def save_processed_data(self, df_resampled, output_dir):
        ...
        processed_data_path = os.path.join(output_dir, 'pateIsoTree3V3HourlySumProcessedData.csv')
...
if __name__ == "__main__":
    ...
    attributes_path = os.path.join(output_dir, 'pateIsoTree3V3HourlySumAttributes.txt')
